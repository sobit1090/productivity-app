    ...
    >
      <div className="flex items-stretch min-h-[68px]">
        ...
        <div
          {...attributes}
          {...listeners}
          className="flex items-center justify-center px-2 cursor-grab active:cursor-grabbing text-gray-500 hover:text-white bg-[rgba(255,255,255,0.02)] border-r border-solid border-[var(--color-border-tertiary)] transition-colors"
        ...
        {/* Time column (horizontal text-like input layout) */}
        <div 
          className="flex items-center justify-center px-4 bg-[rgba(255,255,255,0.01)] border-r border-solid border-[var(--color-border-tertiary)]" 
      ...
      {/* Inline Edit Bar */}
      {showEditBar && (
        <div className="flex flex-wrap items-center justify-between gap-4 p-3 border-t border-solid border-[var(--color-border-tertiary)] bg-[#171716]">
          ...
          <button
            ...
            className="px-3 py-1 text-xs font-semibold bg-[#7F77DD] hover:bg-[#6860c4] text-white rounded cursor-pointer transition-colors"
          >
            Done
          </button>
        </div>
